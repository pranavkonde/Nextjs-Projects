...
export default function Footer(){
  ...
  <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
    ...
    <div class="col mb-3" style={{display:"block", alignItems:"center"}} >
      <h5>Company</h5>
      <ul class="nav flex-column">
        ...
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Swiggy One</a></li>
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Swiggy Instamart</a></li>
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Swiggy Genie</a></li>
      </ul>
    </div>
    ...
    <div class="col mb-3">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Partner with us</a></li>
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Ride with us</a></li>
      </ul>
    </div>
    ...
    <div class="col mb-3">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Investor Relations</a></li>
      </ul>
    </div>
